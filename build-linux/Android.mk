...
LOCAL_CFLAGS += -DBUILDING_LIBCHARSET

LOCAL_C_INCLUDES :=
LOCAL_C_INCLUDES += $(LOCAL_PATH)/../srclib
LOCAL_C_INCLUDES += $(LOCAL_PATH)/../libcharset
...
LOCAL_LDFLAGS += -Wl,--version-script,$(LOCAL_PATH)/iconv.map
